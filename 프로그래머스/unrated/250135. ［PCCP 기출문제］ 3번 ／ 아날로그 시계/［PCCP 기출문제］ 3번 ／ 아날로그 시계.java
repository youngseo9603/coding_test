...
//         while(!(h1==h2 && m1==m2 && s1==s2) && h1<12){
//             if(checkM(h1,m1,s1)){
//                 answer++;
//                 System.out.println("M "+h1 + " " + m1 + " " + s1);
//             }
//             if(checkH(h1,m1,s1)){
//                 answer++;
//                 System.out.println("H " + h1 + " " + m1 + " " + s1);
//             }
//             if((h1==11 && m1==59 && s1==59) || (h1==0 && m1==0 && s1==0)){
//                 answer--;
//             }
...
//         while(!(h1==h2 && m1==m2 && s1==s2) && h1>=12){
//             if(checkM(h1-12,m1,s1)){
//                 answer++;
//                 System.out.println("M " + h1 + " " + m1 + " " + s1);
//             }
//             if(checkH(h1-12,m1,s1)){
//                 answer++;
//                 System.out.println("H " + h1 + " " + m1 + " " + s1);
//             }
//             if((h1==23 && m1==59 && s1==59) || (h1==12 && m1==0 && s1==0)){
//                 answer--;
//             }
...
//     public boolean checkM(int h, int m, int s){
//         double[] now = degree(h,m,s);
//         double[] after = degree(h,m,s+1);
        
//         if( (now[1]<now[2] && now[2]<after[1]) || (now[2] <= now[1] && now[1] <= after[2]) )
//             return true;
        
//         return false;
//     }
    
//     public boolean checkH(int h, int m, int s){
//         double[] now = degree(h,m,s);
//         double[] after = degree(h,m,s+1);
        
//         if( (now[0]<now[2] && now[2]<after[0]) || (now[2] <= now[0] && now[0] <= after[2]) )
//             return true;
        
//         return false;
//     }
    
//     public double[] degree(int h, int m, int s){
//         double[] time = new double[3];
//         time[0] = 30 * (h % 12) + 0.5 * m + (1/120) * s;
//         time[1] = 6 * m + 0.1 * s;
//         time[2] =  6 * s;
